...
public class BoardDaoImpl implements BoardDao {
    ...
    public int boardInsert(BoardDto boardDto) {
        ...
        try {
            ...
            sb.append("INSERT INTO BOARD ( USER_SEQ, TITLE, CONTENT, REG_DT, LIKES ) ");
    ...
    public List<BoardDto> boardList(int limit, int offset) {
        ...
        try {
            ...
            StringBuilder sb = new StringBuilder();
            sb.append("SELECT b.BOARD_ID, b.USER_SEQ, u.USER_NM, u.PROFILE_IMG, b.TITLE, b.CONTENT, b.REG_DT, b.LIKES ");
            sb.append("  FROM BOARD b, USERS u");
            sb.append(" WHERE b.USER_SEQ = u.USER_NUM");            
...
//            System.out.println(rs);
            ...
            while(rs.next()) {
                ...
                boardDto.setUserName(rs.getString("USER_NM"));
//                boardDto.setUserProfileImg(rs.getString("USER_PROFILE_IMG"));
    ...
    public List<BoardDto> boardListSearchWord(int limit, int offset, String searchWord) {
        ...
        try {
            ...
            StringBuilder sb = new StringBuilder();
            sb.append("SELECT b.BOARD_ID, b.USER_SEQ, u.USER_NM, b.TITLE, b.CONTENT, b.REG_DT, b.LIKES ");
            sb.append("  FROM BOARD b, USERS u ");
            sb.append(" WHERE b.USER_SEQ = u.USER_NUM ");
...
//                boardDto.setUserProfileImg(rs.getString("USER_PROFILE_IMG"));
    ...
    public BoardDto boardDetail(int boardId) {
        ...
        try {
            ...
            StringBuilder sb = new StringBuilder();
            sb.append("SELECT b.BOARD_ID, b.USER_SEQ, u.USER_NM, ");
            sb.append("       b.TITLE, b.CONTENT, b.REG_DT, b.LIKES ");
            sb.append("  FROM BOARD b, USERS u ");
            sb.append(" WHERE b.BOARD_ID = ? ");
            sb.append("   AND b.USER_SEQ = u.USER_NUM ");
