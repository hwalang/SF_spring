      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto p-4 p-lg-0">
          ...
          <a href="favorites.jsp" id="navFavorite" class="nav-item nav-link"
            >즐겨찾기</a
          >
          <a href="mypage.jsp" id="navMyPage" class="active nav-item nav-link"
            >마이페이지</a
          >
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto p-4 p-lg-0">
          ...
          <a href="board.jsp" class="nav-item nav-link">게시판</a>
          <a href="find.jsp" class="nav-item nav-link">여행지 찾기</a>
          ...
          <div class="modal-body">
            ...
            <form action="/loginout" method="post">
              <div class="mb-3">
              	...
              	<input type="hidden" value="mypage" name="path"><br>
...
<!-- modal 끝 -->
      ...
      <div class="container py-5">
        ...
        <nav aria-label="breadcrumb animated slideInDown">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item text-white active" aria-current="page">마이페이지</li>
          </ol>
        </nav>
      </div>
    </div>
        ...
        <div class="row g-0 mx-lg-0">
          ...
          <div class="col-lg-6 quote-text py-5 wow fadeIn bg-light" data-wow-delay="0.5s">
            <div class="p-lg-5 pe-lg-0">
              <h6 class="text-primary p-2">내정보</h6>
              <div class="row g-3">
                <div class="col-12"><div class="p-2 fs-4"><%= userDto.getUserName() %></div></div>
                <div class="col-12"><div class="p-2 fs-4"><%= userDto.getUserEmail() %></div></div>
                <div class="col-12"><div class="p-2 fs-4"><%= userDto.getUserPhone() %></div></div>
                <!-- dropbox -->
              ...
              <div class="row mt-3">
                <div class="col-12">
                  <button id="btnUpdateMyPage" class="btn btn-primary rounded-pill py-1 px-4">수정</button>
                  <form class="mt-2" action="/users" method="post">
                  	<input type="hidden" value="R" name="job"><br>
                  	<button type="submit" id="cancelMember" class="btn btn-primary rounded-pill py-1 px-4">회원탈퇴</button>
                  </form>
    ...
    <div id="modalByUpdateMyPage" class="modal" tabindex="-1">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
          ...
          <div class="modal-body">
            <!-- form -->
            <form action="/users" method="get">
            <input type="hidden" value="M" name="job"><br>
              <div class="mb-3">
                <label for="updateName" class="form-label">이름</label>
                <input type="text" name="userName" class="form-control" id="updateName" aria-describedby="emailHelp" />
              </div>
              <div class="mb-3">
                <label for="updateEmail" class="form-label">이메일</label>
                <input type="email" name="userEmail" class="form-control" id="updateEmail" aria-describedby="emailHelp" />
              </div>
              <div class="mb-3">
                <label for="registerInputPhone" class="form-label">전화번호</label>
                <input type="tel" name="userPhone" class="form-control" id="updateInputPhone" aria-describedby="phoneHelp" />
              </div>
              <div class="mb-3">
                <label for="updatePassword" class="form-label">비밀번호</label>
                <input type="password" name="userPassword" class="form-control" id="updatePassword" />
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">취소</button>
                <button type="submit" id="btnUpdate" class="btn btn-primary">수정 완료</button>
              </div>
            </form>
          </div>
        </div>
    ...
    <div class="container-fluid bg-dark text-body footer mt-5 pt-5 wow fadeIn" data-wow-delay="0.1s">
      <div class="container py-5">
        <div class="row g-5">
          ...
          <div class="row g-2">
            <div class="col-2">
              <img class="img-fluid rounded" src="https://www.visitbusan.net/uploadImgs/files/cntnts/20191229153531987_oen" alt="" />
            </div>
            <div class="col-2">
              <img class="img-fluid rounded" src="https://www.visitbusan.net/uploadImgs/files/cntnts/20220808115019607_wufrotr" alt="" />
            </div>
            <div class="col-2">
              <img class="img-fluid rounded" src="https://www.visitbusan.net/uploadImgs/files/cntnts/20200717114921495_oen" alt="" />
            </div>
            <div class="col-2">
              <img class="img-fluid rounded" src="https://www.visitbusan.net/uploadImgs/files/cntnts/20191229142305192_oen" alt="" />
            </div>
            <div class="col-2">
              <img class="img-fluid rounded" src="https://www.visitbusan.net/uploadImgs/files/cntnts/20191229160530047_oen" alt="" />
            </div>
            <div class="col-2">
              <img class="img-fluid rounded" src="https://www.visitbusan.net/uploadImgs/files/cntnts/20191231193128851_wufrotr" alt="" />
            </div>
          </div>
          <!-- </div> -->
        </div>
      ...
      <div class="container">
        <div class="copyright">
          <div class="row">
            <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">&copy; <a href="#">한국 관광지 추천 페이지</a></div>
