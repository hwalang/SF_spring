...
// PreparedStaement 객체 <= 변수를 맨 SQL 을 미리 parse, complie 한 후, 반복적인 작업은 parameter 만 변경 처리
//   => 속도가 빠르고 보안에도 유리하다.
// ResultSet 은 grid 형태의 자료구조를 가지고 있다. 
...
public class Test {
	...
	public static void main(String[] args) throws Exception{
		...
		//      JDBC Dirver Class 의 코드안에서 static initializer 를 이용해서 자기자신 객체를 JDBC Driver 객체에 등록
